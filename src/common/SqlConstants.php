...
class SqlConstants {
	...
	public static $QUERY_BLOG_OF_FIRST_CATE = "FROM BLOG AS B WHERE CATEGORY_ID IN(SELECT C.CATEGORY_ID FROM CATEGORY AS C WHERE PARENT_ID = ?) ORDER BY CREATE_TIME LIMIT ?,?";
