...
class SqlConstants {
	...
	public static $BLOG_SELECT = "SELECT B.ID, B.TITLE, B.AUTHOR, B.CONTENT, B.CREATE_TIME, B.VIEW_NUM, B.WEIGHT, B.URL, B.CATEGORY_ID ";
	...
	public static $GET_BLOG_BY_CAT_ID = "SELECT B.ID, B.TITLE, B.AUTHOR, B.CONTENT, B.CREATE_TIME, B.VIEW_NUM, B.WEIGHT, B.URL, B.CATEGORY_ID
				  FROM BLOG AS B
                  WHERE B.CATEGORY_ID  = ? ORDER BY B.WEIGHT DESC, B.CREATE_TIME DESC LIMIT ?,?";
	...
	public static $QUERY_BLOG_OF_FIRST_CATE = "FROM BLOG AS B WHERE CATEGORY_ID IN(SELECT C.CATEGORY_ID FROM CATEGORY AS C WHERE PARENT_ID = ?) ORDER BY B.WEIGHT DESC, CREATE_TIME LIMIT ?,?";
...
FROM 
(
SELECT P.BLOG_ID, MAX(UPDATE_TIME) UPDATE_TIME
